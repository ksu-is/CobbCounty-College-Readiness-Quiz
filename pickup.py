...
def get_questions():
    ...
    questions = []
    with open('questionsforCobbCountyQuiz.txt', 'r') as finalquest_handle:
...
def get_all_anwers():
    ...
    with open('alltheanswersforquiz.txt' , 'r') as allanswers_handle:
...
def get_correct_answers():
    ...
    correct_answers = []
    with open ('correct_answers_for_quiz.txt', 'r') as finalanswer_handle:
...
def run_quiz():
    ...
    def find_if_finished():
        finished_list = []
        with open ('thefinishedquiz.txt' , 'r') as finished_file_handle:
